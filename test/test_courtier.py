...
class TestAchatCasNominaux:
    ...
    def test_je_ne_peux_pas_acheter_a_3000_dollars(self):
        bitcoin_api_service: JObtiensLeCoursDuBitcoin = Mock(JObtiensLeCoursDuBitcoin)
        bitcoin_api_service.recupere_le_cours_actuel_du_bitcoin.return_value = 3000
        courtier = Courtier(bitcoin_api_service)
...
class TestAchatLimites:
    def test_je_peux_acheter_a_2400_99_dollars(self):
        bitcoin_api_service: JObtiensLeCoursDuBitcoin = Mock(JObtiensLeCoursDuBitcoin)
        bitcoin_api_service.recupere_le_cours_actuel_du_bitcoin.return_value = 2400.99
        courtier = Courtier(bitcoin_api_service)
    ...
    def test_je_ne_peux_pas_acheter_a_2401_dollars(self):
        bitcoin_api_service: JObtiensLeCoursDuBitcoin = Mock(JObtiensLeCoursDuBitcoin)
        bitcoin_api_service.recupere_le_cours_actuel_du_bitcoin.return_value = 2401
        courtier = Courtier(bitcoin_api_service)
